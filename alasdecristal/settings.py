...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_ROOT, 'files', 'database', 'db.sqlite3'),
        'USER': '',
        'PASSWORD': '',
        'HOST': '',
        'PORT': '',
...
MEDIA_ROOT = os.path.join(PROJECT_ROOT, 'files', 'public', 'media')
...
STATIC_ROOT = os.path.join(PROJECT_ROOT, 'files', 'public', 'static')
...
ROOT_URLCONF = 'alasdecristal.urls'
